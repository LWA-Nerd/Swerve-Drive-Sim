...
import frc.swerve.GyroIO;
import frc.swerve.GyroIOPigeon;
...
public class SwerveDrive extends SubsystemBase {
    ...
    public Command runDriveInputs(
        ...
        return run(() -> {
            ...
            mag *= (DriverStation.isAutonomous() ? 4.5 : Constants.kMagVelLimit)  /*speed.getAsDouble()*/ * speedFactor;
            omega = adjustAxisInput(omega, deadband, minThreshold, steepness + 1);
            omega *= Constants.kRotVelLimit * speedFactor;
    ...
    private void submitChassisSpeeds(
        ...
        SwerveDriveKinematics.desaturateWheelSpeeds(moduleSetpoints, Constants.kMaxWheelSpeed);
